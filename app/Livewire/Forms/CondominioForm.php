...
{
    #[Validate('min:0', as: 'tipo condominio')]
    public $id_tipo_condominio;
    ...
    public function mount(Tenant|Null $condominio)
    {
        $this->horarios = [
            'Mon' => [],
            'Tue' => [],
        ...
        if($condominio) {
            $this->fill($condominio);

            foreach($condominio->horarios as $key => $values) {
