    ...
    public function unlink($rowId, $params=null): void
    {
        if($params == null) {
            $this->dialog()->confirm([
                ...
                'description' => 'Desvincular este usuário da sua Condominio?<br/>Para que ele volta a trabalhar com você, precisará enviar um convite.',
    ...
    public function actions(User $row): array
    {
        return [
            ...
            Button::add('unlink')
                ...
                ->class('pg-btn-white dark:ring-pg-primary-600 dark:border-pg-primary-600 dark:hover:bg-pg-primary-700 dark:ring-offset-pg-primary-800 dark:text-pg-primary-300 dark:bg-pg-primary-700')
                ->id()
                ->can((auth()->user()->isAdmin() || auth()->user()->isCondominio()) && auth()->id() != $row->id)
